/**
 * User 2Factor Disable Controller
 *
 * Contains functions related to handling 2FA Disable responses and actions.
...
// Declare the User 2Factor Disable Controller.
const Disable2FactorController = {};

/**
 * Determine post User 2Factor Disable response action
 *
 * Function takes in the status of the User 2Factor Disable response in order to
 ...
 */
Disable2FactorController.handleResponse = async (response, languageData) => {
 ...
 *
 * Uses the custom Response Handler to handle User 2Factor Disable actions.
 *
 ...
 */
Disable2FactorController.handleAction = (responseObject, data, action) => {
...
export default Disable2FactorController;